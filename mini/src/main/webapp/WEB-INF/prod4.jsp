						...
						<ul class="slidelist">							
							<li class="slideitem">
								<div>
									...
									<img src="../image/banner/kitchen_banner.jpg">
								</div>
							</li>
							<li class="slideitem">
								<div>
									...
									<img src="../image/banner/kitchen_banner2.jpg">
								</div>
							</li>
							<li class="slideitem">
								<div>
									...
									<img src="../image/banner/kitchen_banner3.jpg">
								</div>
							</li>
							<li class="slideitem">
								<div>
									...
									<img src="../image/banner/kitchen_banner4.jpg">
								</div>
							</li>
						</ul>
					</div>
