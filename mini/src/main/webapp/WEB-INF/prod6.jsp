						...
						<ul class="slidelist">							
							<li class="slideitem">
								<div>
									...
									<img src="../image/banner/bathroom_banner.jpg">
								</div>
							</li>
							<li class="slideitem">
								<div>
									...
									<img src="../image/banner/bathroom_banner1.jpg">
								</div>
							</li>
							<li class="slideitem">
								<div>
									...
									<img src="../image/banner/bathroom_banner2.jpg">
								</div>
							</li>
							<li class="slideitem">
								<div>
									...
									<img src="../image/banner/bathroom_banner4.jpg">
								</div>
							</li>
						</ul>
					</div>
...
var app = new Vue({ 
    ...
    , methods: {
        ...
        fnGetProductList : function(){
            ...
            var nparmap = {pKind : self.pKind ,startNum : startNum, lastNum : lastNum, keywordType : self.selectItem, keyword : self.keyword, keywordType : self.selectItem};
            $.ajax({
                url:"/productList.dox",
                dataType:"json",	
                type : "POST", 
